...
- `info/tables/source_data_overview.csv`
- `info/tables/cleaning_summary.csv`
- `info/tables/student_visit_distribution_exact.csv`
- `info/tables/student_visit_distribution_tail.csv`
- `info/tables/student_visit_thresholds.csv`
- `info/tables/visit_summary.csv`
- `info/tables/visits_by_year.csv`
- `info/tables/asesorias_raw_year_summary.csv`
- `info/tables/classroom_unit_summary.csv`
- `info/tables/classroom_size_distribution.csv`
- `info/tables/professor_summary.csv`
- `info/tables/subject_summary.csv`
- `info/tables/student_summary.csv`
- `info/tables/grade_missingness_summary.csv`
- `info/tables/raw_grade_non_numeric_tokens.csv`
- `info/tables/threshold_summaries.csv`
- `info/tables/concentration_summary.csv`
- `info/tables/lorenz_visits.csv`
- `info/tables/student_classroom_units_per_student_distribution.csv`
- `info/tables/top_students_by_visits.csv`

## Generated Figures

- `info/figures/visits_histogram.pdf`
- `info/figures/visits_histogram.png`
- `info/figures/visits_histogram_low_counts.pdf`
- `info/figures/visits_histogram_low_counts.png`
- `info/figures/visits_ecdf.pdf`
- `info/figures/visits_ecdf.png`
- `info/figures/visits_tail_curve.pdf`
- `info/figures/visits_tail_curve.png`
- `info/figures/visits_continuation_curve.pdf`
- `info/figures/visits_continuation_curve.png`
- `info/figures/visits_by_year.pdf`
- `info/figures/visits_by_year.png`
- `info/figures/classroom_size_distribution.pdf`
- `info/figures/classroom_size_distribution.png`
- `info/figures/visits_lorenz_curve.pdf`
- `info/figures/visits_lorenz_curve.png`

## Generated LaTeX Snippets

- `info/tex/descriptive_summary.tex`
- `info/tex/core_counts_table.tex`
- `info/tex/visits_distribution_table.tex`
- `info/tex/year_summary_table.tex`
- `info/tex/cleaning_summary_table.tex`
- `info/tex/concentration_table.tex`
- `info/tex/grade_overview_table.tex`
- `info/tex/grade_tokens_table.tex`
