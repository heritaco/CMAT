...
DEFAULT_MATERIAS_PATH = PROJECT_ROOT / "data/onedrive/Archivos2024/Materias estudiantes-profesores 2019-2025 P y O.xlsx"
DEFAULT_ASESORIAS_PATH = PROJECT_ROOT / "data/onedrive/Archivos2024/Asesorias2024.xlsx"
RAW_OUTPUT_DIR = PROJECT_ROOT / "visualizations/nb_04reportes_raw"
PROF_OUTPUT_DIR = PROJECT_ROOT / "visualizations/profes_distributions"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Regenerate the figures from notebooks/04 Reportes/00 Raw.ipynb."
    )
