...
\IfFileExists{reportes/seccion_analisis_paradojico.tex}{\input{reportes/seccion_analisis_paradojico.tex}}{}
...
\begin{itemize}
    ...
    \item \code{data/datos\_procesados/merged\_dataset.csv} y \code{.xlsx}
    \item \code{data/datos\_procesados/analysis\_dataset.csv} y \code{.xlsx}
    \item \code{data/datos\_procesados/paradoxical\_group\_dataset.csv} y \code{.xlsx}
    \item \code{data/datos\_procesados/professor\_appendix\_all\_years.csv} y \code{.xlsx}
    \item \code{data/datos\_procesados/professor\_appendix\_by\_period.csv} y \code{.xlsx}
    \item \code{data/datos\_procesados/README.md} y \code{data/datos\_procesados/data\_dictionary.md}
\end{itemize}
...
\IfFileExists{reportes/apendice_tablas_profesores.tex}{\input{reportes/apendice_tablas_profesores.tex}}{\IfFileExists{apendice_tablas_profesores.tex}{\input{apendice_tablas_profesores.tex}}{}}
